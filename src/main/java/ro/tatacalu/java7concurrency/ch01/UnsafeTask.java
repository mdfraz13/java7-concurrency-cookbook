...
public class UnsafeTask implements Runnable {
    ...
    public void run() {
        ...
        System.out.printf(STRING_THREAD_START, Thread.currentThread().getId(), this.startDate);
        ...
        System.out.printf(STRING_THREAD_END, Thread.currentThread().getId(), this.startDate);
    }
